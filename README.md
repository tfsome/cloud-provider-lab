- [Problem to Be Solved](README.md#problem-to-be-solved-in-this-lab)
  * [Explanation of the Solution](README.md#explanation-of-the-solution)
  * [PRE-REQUISITES](README.md#pre-requisites)
- [Creating Infrastructure](README.md#creating-infrastructure)
  * [TASK 1 - Creating Network Resources](README.md#task-1---creating-network-resources)
  * [TASK 2 - Create resources for SSH Authentication](README.md#task-2---create-resources-for-ssh-authentication)
  * [TASK 3 - Create an Object Storage](README.md#task-3---create-an-object-storage)
  * [TASK 4 - Create IAM Resources](README.md#task-4---create-iam-resources)
  * [TASK 5 - Configure Network Security](README.md#task-5---configure-network-security)
  * [TASK 6 - Form TF Output](README.md#task-6---form-tf-output)
  * [TASK 7 - Configure a remote data source](README.md#task-7---configure-a-remote-data-source)
  * [TASK 8 - Configure application instances behind a Load Balancer](README.md#task-8---configure-application-instances-behind-a-load-balancer)
  * [TASK 9 - Use data discovery](README.md#task-9---use-data-discovery)
- [Working with Terraform state](README.md#working-with-terraform-state)
  * [TASK 10 - Move resources](README.md#task-10---move-resources)
  * [TASK 11 - Move state to other backends](README.md#task-11---move-state-to-other-backends)
  * [TASK 12 - Import resources](README.md#task-12---import-resources)
- [Advanced tasks](README.md#advanced-tasks)
  * [TASK 13 - Expose node output with nginx](README.md#task-13---expose-node-output-with-nginx)
  * [TASK 14 - Modules](README.md#task-14---modules)
